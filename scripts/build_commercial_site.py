...
</div></footer><section class="consent-banner" role="dialog" aria-modal="false" aria-labelledby="consent-title" hidden><div><h2 id="consent-title">Optional analytics</h2><p>With your permission, Google Analytics helps us understand site usage. We do not load analytics before you accept. See our <a href="/privacy/#analytics">privacy notice</a>.</p></div><div class="consent-actions"><button class="button secondary js-consent-reject" type="button">Reject analytics</button><button class="button js-consent-accept" type="button">Accept analytics</button></div></section>"""
