...
<div><h3>Company</h3><a href="/about/">About</a><a href="/contact/">Contact</a><a href="/privacy/">Privacy</a><a href="/terms/">Website terms</a></div></div>
<div class="footer-bottom"><span>© 2026 INMAR d.o.o. · PulseWatch service</span><span>Gardinovec 24, 40319 Belica, Croatia</span></div>
</div></footer>"""
...
<link rel="stylesheet" href="/assets/site.css"><script type="application/ld+json">{schema(title, description, canonical, page_type)}</script></head><body>{header(current)}<main id="main">{body}</main>{footer()}<script src="/assets/site.js" defer></script></body></html>'''
...
home = """<section class="hero"><div class="wrap hero-grid"><div><span class="eyebrow">Managed competitor intelligence</span><h1>Know what changed.<br>Decide what to do next.</h1><p class="lede">PulseWatch helps specialist CRO and performance agencies turn important competitor website, offer, pricing and messaging changes into reviewed evidence, client-ready recommendations and owned next actions.</p><div class="hero-actions"><a class="button" href="/paid-pilot/">Explore the 30-day pilot</a><a class="button secondary" href="/sample-report/">Open the sample report</a></div><p class="microcopy">Prepaid pilot · one client account · five competitors · up to 30 agreed public URLs</p></div>
<div class="signal-board" aria-label="Example reviewed signal"><div class="board-head"><div><strong>Reviewed signal</strong><div class="board-title">Illustrative report format</div></div><span class="badge reviewed">REVIEWED</span></div><div class="signal-change"><span class="badge high">HIGH RELEVANCE</span><h3>Core offer repositioned</h3><p>The primary message moved from product automation to a managed outcome.</p><div class="comparison"><div class="snapshot"><strong>Before</strong><span>Tool-led monitoring</span></div><span>→</span><div class="snapshot"><strong>After</strong><span>Decision-ready service</span></div></div></div><div class="board-action"><small>Recommended action</small><strong>Review your own category promise and test an outcome-led hero.</strong></div></div></div></section>
...
pilot = (
    hero(
        ...
        "A fixed-scope, prepaid engagement for one agency client account. The goal is not to produce more alerts. It is to test whether reviewed competitor signals improve a real decision.",
    )
...
how = (
    hero(
        ...
        "PulseWatch uses a five-part operating method so the buyer can see where observation ends, judgment begins and business responsibility remains.",
    )
...
page(
    ...
    "PulseWatch is an early managed competitor-intelligence service operated by INMAR d.o.o. with direct human responsibility.",
    about,
    current="/about/",
    page_type="AboutPage",
)
...
privacy = (
    hero(
        ...
        "How INMAR d.o.o. processes contact details submitted through the PulseWatch managed-pilot form. Last updated 21 August 2026.",
    )
    + """<section class="section white"><div class="wrap legal"><div class="notice"><strong>Controller:</strong> INMAR d.o.o., Gardinovec 24, 40319 Belica, Croatia. Use the <a href="https://inmar.hr/#contact">INMAR contact form</a> for privacy, access or deletion requests.</div><h2>What we collect</h2><p>The managed-pilot enquiry form stores the work email address you submit and the submission time. The form does not intentionally store your IP address.</p><h2>Why we use it</h2><p>We use the address only to review whether the proposed PulseWatch pilot is a fit, send the requested pilot information and answer related pre-contract questions. We do not sell submitted contact data.</p><h2>Retention</h2><p>Unconverted pilot enquiries are automatically removed from the lead file after 90 days. If you become a client, information needed for the service, contract, accounting or legal obligations is handled under the relevant client documentation and retention rules.</p><h2>Service providers and access</h2><p>The lead file is stored in restricted server-side storage and is not intended to be publicly accessible. Access is limited to people and service providers needed to operate the site, hosting and enquiry process. We require a separate decision and notice before adding optional notification or marketing processors.</p><h2>Your choices and rights</h2><p>You may ask whether we hold your enquiry, request a copy or correction, object to processing, or request deletion where applicable. Submit the request through the INMAR contact form linked above. You may also complain to the competent data-protection authority.</p><h2>No marketing subscription</h2><p>Submitting the pilot form is not consent to an unrelated marketing newsletter. Any future marketing subscription must use a separate, explicit choice.</p></div></section>"""
)
page(
    "/privacy/",
    "Privacy notice",
    "How INMAR d.o.o. processes work email addresses submitted through the PulseWatch managed-pilot enquiry form.",
    privacy,
)
